...
export const confirmOrderMaterial = async (id, newData) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/material/order/confirm/${id}`;
    const body = newData;
    return(myPut(url, body));
}
export const cancelOrderMaterialById = async (id) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/material/order/cancel/${id}`;
    return(myPut(url, {}));
}
export const confirmOrder = async (id, data) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/orders/confirm/${id}`;
    const body = data;
    return(myPut(url,body));
}
export const updateSchedule = async (data) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/schedule/update`;
    const body = data;
    return(myPut(url,body));
}
...
export const cancelOrderById = async (id) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/orders/cancel/${id}`;
    return (myPut(url,{}));
}

export const updateEquipment = async(id,newData,oldData) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/equipment/${id}`;
    const body = diferential(newData,oldData);
    return(myPut(url, body));
}

export const finishTotalOrderById = async (id) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/orders/finishTotal/${id}`;
    return (myPut(url, {}));
}

export const updateOver = async (data) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/material/over`;
...
export const addStepById = async (id) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/step/next/${id}`;
    let response = await myPut(url,{});
    return (response);
}

export const logoutWWeb = async () => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/whatsapp/logout`;
    let response = await myPut(url,{});
    return (response);
}

export const updateNotificationsWWeb = async (state) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/whatsapp/notifications`;
    let response = await myPut(url,{notifications:state});
    return (response);
}

export const updateConfigEmail = async(body) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/email`;
...
export const updateConfigBinnacle = async(body) => {
    const url = `${process.env.REACT_APP_SERVER_HOST}/api/binnacle`;
    let response = await myPut(url,body);
    return (response);
}